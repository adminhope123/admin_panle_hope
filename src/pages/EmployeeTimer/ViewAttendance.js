import { Avatar, Box, Stack, Table, TableBody, TableCell, TableRow, Typography } from '@mui/material'
...
export default function ViewAttendance() {
  ...
  const handleChangeMonth = (month) => {
    ...
    const monthdata = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
    const dataGEt = smonth
    const getFormet = monthdata[smonth - 1]
              ...
              <>
                <div className='not-data'>
                  <div className='not-task'>
                    ...
                    <div class="empty-state__message">Not Attendance Data</div>
                  </div>
                </div>
              </> :
              getMonthData && getMonthData?.map((item) => {
                return (
                  <>
                      ...
                      <TableRow>
                        ...
                        <TableCell align='center'>
                          <div  style={{
                             border:"1px solid",
                             borderRadius:"4px",
                            borderColor:`${item?.totalworkrange <'50%'?'#f44336' :'#61af61'}`,
                          }}>
                          <div
                           style={{
                            width:`${item?.totalworkrange}`,
                            backgroundColor:`${item?.totalworkrange <'50%'?'#f44336' :'#61af61'}`,
                          }
                        
                          }
                            ><span   style={{
                             color:`${item?.totalworkrange <'50%'?'#f44336' :'#61af61'}`,
                           }}>ss</span></div>
                          </div>
                        </TableCell>
